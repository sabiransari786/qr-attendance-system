...
async function run() {
  ...
  try {
    ...
    // Insert sessions
    // [subject, status, start_time, end_time, location, qr_expiry_time]
    const sessions = [
      ['Data Structures',     'active', '2026-02-21 10:00:00', '2026-02-21 11:30:00', 'Room 301', '2026-02-21 10:15:00'],
      ['Web Development',     'active', '2026-02-21 14:00:00', '2026-02-21 15:30:00', 'Lab 201',  '2026-02-21 14:15:00'],
      ['Database Management', 'closed', '2026-02-20 10:00:00', '2026-02-20 11:30:00', 'Room 302', '2026-02-20 10:15:00'],
      ['Algorithm Design',    'closed', '2026-02-20 14:00:00', '2026-02-20 15:30:00', 'Room 303', '2026-02-20 14:15:00'],
      ['Operating Systems',   'closed', '2026-02-19 10:00:00', '2026-02-19 11:30:00', 'Lab 101',  '2026-02-19 10:15:00'],
      ['Data Structures',     'closed', '2026-02-19 13:00:00', '2026-02-19 14:30:00', 'Room 301', '2026-02-19 13:15:00'],
      ['Web Development',     'closed', '2026-02-18 09:00:00', '2026-02-18 10:30:00', 'Lab 201',  '2026-02-18 09:15:00'],
      ['Database Management', 'closed', '2026-02-18 14:00:00', '2026-02-18 15:30:00', 'Room 302', '2026-02-18 14:15:00'],
      ['Operating Systems',   'closed', '2026-02-17 10:00:00', '2026-02-17 11:30:00', 'Lab 101',  '2026-02-17 10:15:00'],
      ['Algorithm Design',    'closed', '2026-02-17 13:00:00', '2026-02-17 14:30:00', 'Room 303', '2026-02-17 13:15:00'],
      ['Data Structures',     'closed', '2026-02-14 10:00:00', '2026-02-14 11:30:00', 'Room 301', '2026-02-14 10:15:00'],
      ['Web Development',     'closed', '2026-02-14 13:00:00', '2026-02-14 14:30:00', 'Lab 201',  '2026-02-14 13:15:00'],
      ['Database Management', 'closed', '2026-02-13 10:00:00', '2026-02-13 11:30:00', 'Room 302', '2026-02-13 10:15:00'],
      ['Operating Systems',   'closed', '2026-02-13 14:00:00', '2026-02-13 15:30:00', 'Lab 101',  '2026-02-13 14:15:00'],
      ['Algorithm Design',    'closed', '2026-02-12 09:00:00', '2026-02-12 10:30:00', 'Room 303', '2026-02-12 09:15:00'],
      ['Data Structures',     'closed', '2026-02-12 13:00:00', '2026-02-12 14:30:00', 'Room 301', '2026-02-12 13:15:00'],
      ['Web Development',     'closed', '2026-02-11 10:00:00', '2026-02-11 11:30:00', 'Lab 201',  '2026-02-11 10:15:00'],
      ['Database Management', 'closed', '2026-02-11 14:00:00', '2026-02-11 15:30:00', 'Room 302', '2026-02-11 14:15:00'],
      ['Operating Systems',   'closed', '2026-02-10 09:00:00', '2026-02-10 10:30:00', 'Lab 101',  '2026-02-10 09:15:00'],
      ['Algorithm Design',    'closed', '2026-02-10 13:00:00', '2026-02-10 14:30:00', 'Room 303', '2026-02-10 13:15:00'],
    ];

    const insertedIds = [];
    for (const s of sessions) {
      const [r] = await pool.execute(
        'INSERT INTO sessions (subject, faculty_id, status, start_time, end_time, location, qr_expiry_time) VALUES (?, 3, ?, ?, ?, ?, ?)',
        s
      );
